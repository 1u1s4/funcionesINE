...
pkg.env$ignorado <- c("Ignorado", "ignorado", "IGNORADO", "Ignorada", "ignorada", "otro", "otros", "otra", "otras", "Otras", "Otros")
pkg.env$exclusion <- c(pkg.env$ignorado, "otro", "otros", "otra", "otras", "Otras", "Otros")
